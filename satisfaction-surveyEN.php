...
<body>
    <div class="headercontainer">
        <br><br>
        <p>Employees Satisfaction Survey</p>
    </div>

    <div class="detailscontainer">
        <p>We would love to hear from you! <br>This survey will be carried out until 0/0/2024</p>
        <br>
        <p>Objectives of having this survey are as below: <br>
        1. To assess workplace climate<br>
        2. To improve the level of communication<br>
        3. To collect insights into Employees Sentiments</p>
        <p><br>We look forward to seeing the analysis of your responses and hoping for close to 100% participation.
        <br>All of the feedback will be treated as confidential and anonymous.</p>
    ...
    <input type="hidden" name="language" id="language" value="en">
        ...
        <div class="question">
      <p class="radiobtn">1. Overall, how satisfied are you working for the Company? <span style="color:red;">*</span>
      </p>
      <div class="rate">
    ...
    <div class="question">
      <p class="radiobtn">2. To what extent do you agree with the following statement: I would recommend this company
        as a good place to work <span style="color:red;">*</span></p>
      <div class="rate">
    ...
    <div class="question">
            <p>3. What I like the best about working for the Company is <span style="color:red;">*</span></p>
            <input type="text" required placeholder=" " id="q3_likes" name="q3_likes"><br><br>
    </div>
    <div class="question">
            <p>4. Things that the Company should do to make it a better workplace are <span style="color:red;">*</span></p>
            <input type="text" required placeholder=" " id="q4_improvement" name="q4_improvement"><br><br>
    </div>
    <div class="question">
            <p>5. Do you enjoy our company's culture? <span style="color:red;">*</span></p>
            <input type="text" required placeholder=" " id="q5_company_culture" name="q5_company_culture"><br><br>
    </div>
    <div class="question">
      <p class="radiobtn">6. Overall, how satisfied are you working in your department? <span style="color:red;">*</span></p>
      <div class="rate">
    ...
    <div class="question">
            <p>7. Which of the above factors most strongly affects your satisfaction with your work? <span style="color:red;">*</span></p>
            <input type="text" required placeholder=" " id="q7_satisfaction_factors" name="q7_satisfaction_factors"><br><br>
    </div>
    <div class="question">
            <p>8. How many years have you been with the Company? <span style="color:red;">*</span></p>
            <input type="text" required placeholder=" " id="q8_years_working" name="q8_years_working"><br><br>
    </div>
    <div class="question">
            <p>9. What else about your superior affects your job satisfaction? <span style="color:red;">*</span></p>
            <input type="text" required placeholder=" " id="q9_superior_impact" name="q9_superior_impact"><br><br>
    </div>

    <div class="question">
        <p>10. How satisfied are you with the following?</p>
    </div>
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>Your basic salary </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
        <input type="radio" id="q10_rate1" name="q10_basicsalary" value="1" required>
        <label for="q10_rate1">
            <div></div>Extremely Dissatisfied
        </label>
        <input type="radio" id="q10_rate2" name="q10_basicsalary" value="2" required>
        <label for="q10_rate2">
            <div></div>Somewhat Dissatisfied
        </label>
        ...
        <label for="q10_rate4">
            <div></div>Somewhat Satisfied
        </label>
        <input type="radio" id="q10_rate5" name="q10_basicsalary" value="5" required>
        <label for="q10_rate5">
            <div></div>Extremely Satisfied
        </label>
        </div><br>
    </div>
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>Benefit Entitlement </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>Your career progression at the Company thus far </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>Your medical insurance </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>The process used to determine the annual raise </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>The process used to determine employee's promotion </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p>11. Please indicate the extent to which you agree with the following statements.</p>
    </div>
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>Overall, my superior does a good job. </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>My superior actively listens to my suggestions. </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>How transparent do you feel the management is? </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>My superior enables me to perform at my best. </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>It is clear to me what my superior expects of me regarding my job performance. </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>My superior provides me with actionable suggestions on what I can do to improve. </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>When I have questions or concerns, my superior is able to address them. </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>My superior evaluates my work performance on a regular basis. </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>Do you feel as though your job responsibilities are clearly defined? </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn"><span style="padding-left:20px;"></span>Does management seem invested in the success of the team? </span><span style="color:red;">*</span></p>
        <div class="verticalrate">
    ...
    <div class="question">
        <p class="radiobtn">12. Will you recommend this Company to your friend to work with us? <span style="color:red;">*</span></p>
        <div class="verticalrate">
        ...
        <div id="q12_reasonNo" class="reason" style="display:none;">
            <label for="q12_reasonNoInput">Please provide the reason:</label>
            <input type="text" id="q12_reasonNoInput" name="q12_recfriend_reasonNo">
        </div>
        <div id="q12_reasonDK" class="reason" style="display:none;">
            <label for="q12_reasonDKInput">Please provide the reason:</label>
            <input type="text" id="q12_reasonDKInput" name="q12_recfriend_reasonDK">
        </div>
    </div>
    <div class="question">
        <p class="radiobtn">13. Does the Company provide you job security? <span style="color:red;">*</span></p>
        <div class="verticalrate">
        ...
        <div id="q13_reasonNo" class="reason" style="display:none;">
            <label for="q13_reasonNoInput">Please provide the reason:</label>
            <input type="text" id="q13_reasonNoInput" name="q13_jobsecurity_reasonNo">
        </div>
        <div id="q13_reasonDK" class="reason" style="display:none;">
            <label for="q13_reasonDKInput">Please provide the reason:</label>
            <input type="text" id="q13_reasonDKInput" name="q13_jobsecurity_reasonDK">
        </div>
    </div>
    <div class="question">
            <p>14. How open to change are we as an organization? <span style="color:red;">*</span></p>
            <input type="text" required placeholder=" " id="q14_changes_openness" name="q14_changes_openness"><br><br>
    </div>
    <div class="question">
            <p>15. Any other suggestions for the Company improvements? <span style="color:red;">*</span></p>
